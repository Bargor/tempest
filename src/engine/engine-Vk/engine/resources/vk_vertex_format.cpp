...
namespace engine {
    namespace vulkan {
        ...
        vk_vertex_format::vk_vertex_format(const vertex_format&)
        ...
        const vk::VertexInputBindingDescription& vk_vertex_format::get_binding_description() const {
            return m_bindingDescription;
        }

        const std::array<vk::VertexInputAttributeDescription, 2>& vk_vertex_format::get_attribute_descriptions() const {
